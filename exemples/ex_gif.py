...
from dessin import dessiner_gif, pygame, Duree, verifier_pour_quitter, Jeu, Fenetre

# Création du générateur
dessin_gif = dessiner_gif(0, "exemples/gif/frames/*.png", Duree(ms=30), (0, 0), en_boucle=True, etendre=True)
